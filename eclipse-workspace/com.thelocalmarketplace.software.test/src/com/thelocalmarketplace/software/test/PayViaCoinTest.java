package com.thelocalmarketplace.softwre.test;
...
public class PayViaCoinTest {
	...
	public void totalPriceTest() {
		...
		Assert.assertEquals(3,software.totalPrice(shoppingCart));
	}
	
	@Test
	public void payForOrderTest() throws ClassNotFoundException, DisabledException, CashOverloadException {
		shoppingCart.add(productOne);
		shoppingCart.add(productTwo);
		software.payForOrder(coin);
	}
